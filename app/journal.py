...
def getSpecificArticlesfromJournals():
    ...
    (SELECT A.ArticleID, A.Title, A.URL, A.DOI, A.YearPublished, J.JournalName, 
    C.CategoryName FROM Articles AS A, Journals AS J, Category AS C 
